...
//        $this->getMockForTrait('\Kidfund\LaraVault\LaraVault');
...
//    }
    ...
    public function it_enables()
    {
        ...
        $dummyObj = $this->getObjectForTrait('\Kidfund\LaraVault\LaraVault');
    ...
    public function it_encrypts_an_unencrypted_val_using_the_client()
    {
        ...
        $mockClient->expects($this->once())
            ->method('encrypt')
            ->with($this::VAULT_MODEL_KEY.'phone', $this::VALID_PHONE);
    ...
    public function it_decrypts_an_encrypted_val_using_the_client()
    {
        ...
        $mockClient->expects($this->once())
            ->method('decrypt')
            ->with($this::VAULT_MODEL_KEY.'phone', $this::ENCRYPTED_VALUE);
