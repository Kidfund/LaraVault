...
class LaraVaultBaseTest extends TestCase
{
    ...
    public function getMockTransitClient()
    {
        ...
        $mock = $this->getMockBuilder('Kidfund\ThinTransportVaultClient\TransitClient')
    ...
    {
        return $this->getObjectForTrait('\Kidfund\LaraVault\LaraVault');
    }
    ...
    {
        $realTransitClient = LaraVaultServiceProvidor::getTransitClient();
        $mock = $this->getMockBuilder('Kidfund\LaraVault\LaraVaultHasher')
    ...
    {
        $mockClient = $this->getMockTransitClient();
        $mockBuilder = $this->getMockBuilder('Kidfund\LaraVault\LaraVaultHasher', ['keyExists'])
...
//        $mock = $this->getMock('Kidfund\LaraVault\LaraVaultHasher', ['keyExists']);
//
